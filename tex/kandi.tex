...
Tutkielmassa esiteltävät plotit on luotu John Reganin ym. \cite{rj} supermassiivisten mustien aukkojen syntyä mallintavasta simulaatiodatasta. Simulaation tarkoituksena on selittää, kuinka hyvin varhaisessa maailmankaikkeudessa voi syntyä riittävän massiivisia mustia aukkoja selittämään havainnot tutkimalla kaasupilvien romahtamista suoraan mustaksi aukoksi. \cite{rj}
