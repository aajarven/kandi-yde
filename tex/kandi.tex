...
LW-kaistan säteilyn vaikutusta varhaisiin kaasupilviin on tutkittu jo useissa julkaisuissa ja tulokset ovat vaikuttaneet lupaavilta, mutta aiemmissa simulaatioissa säteily on ollut isotrooppista. Tarkasteltavassa John Reganin et al. simulaatiossa on tästä poiketen käytetty pistemäistä säteilylähdettä ja jätetty mahdollisen LW-taustan vaikutukset huomiotta. Tämä todennäköisesti vastaa aiempia simulaatioita paremmin todellisia olosuhteita. \cite{rj}

Simulaatiossa tutkittiin pienehkön halon romahtamista kun 3 kpc päässä siitä on LW-kaistassa säteilevä kohde. 
