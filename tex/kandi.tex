...
Lisäksi dokumentaation \cite{multiplot-api} ja lähdekoodin \cite{multiplot-source} mukaan tukea läpileikkausten ja muiden \yt :n tarjoamien plottien lisäksi myös profiileja. 

\subsubsection{Muutokset \yt :n lähdekoodissa} %subsubsection?
