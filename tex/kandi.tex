...
Selkein tapa mustan aukon synnylle on syntyä tähden kehityksen lopputuotteena. Mikäli esimerkiksi massaltaan luokkaa $100 - 300~M_{\astrosun}$ oleva populaation III tähti romahtaa mustaksi aukoksi punasiirtymällä $z \approx 20$ ja saatavilla on riittävästi materiaa, jotta se voi kasvaa Eddingtonin luminositeetin asettamalla rajalla, voi aukko kasvaa supermassiiviseksi punasiirtymään $z\approx 7$ mennessä. \cite{whalen}%TODO mutta epätodennäköistä koska


\section{\yt :n sovelluksia} %TODO kerro johonkin yleisestä tavasta tehdä animaatio jos osaa jo tehdä yhden plotin? liian rautalankaa?
