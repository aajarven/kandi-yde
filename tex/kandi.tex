...
Projektioiden luominen \yt :llä onnistuu pääpiirteissään samalla tavoin kuin läpileikkaustenkin. Projektiossa % täytyy käydä läpi koko näkösäde, kestää kauemman, kaavat eri tavoista
